...
![Selecting a state machine from the default state machine menu](/images/defaultSM.gif)
...
![Width and Height fields in the Inspector when the artboard is selected](/images/WandH.png)

**Link Icon**

Like other properties where the link icon is found, it can be used to lock the current ratio of the size properties.

![Link icon next to the Width and Height fields for locking the ratio](/images/link.png)
...
![Render Presets panel for an artboard in the inspector panel](/images/render.png)
